...
func ConfigToYaml(cfg *BeaconChainConfig) []byte {
	lines := []string{
		...
		fmt.Sprintf("RETIRED_DEPOSIT_CONTRACT_ADDRESS: %s", cfg.RetiredDepositContractAddress),
		fmt.Sprintf("DEPOSIT_CONTRACT_SWITCH_BLOCK: %d", cfg.DepositContractSwitchBlock),
